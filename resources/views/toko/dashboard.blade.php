                ...
                <div class="col-md-8">
                    <div class="card shadow border-0">
                        <div class="card-body text-center py-5">
                            <img src="https://cdn-icons-png.flaticon.com/512/1376/1376544.png" alt="Store Icon"
                                style="width: 100px; margin-bottom: 20px;">
                            <h3>Anda belum memiliki toko</h3>
                            <p class="text-muted mb-4">Untuk mulai menggunakan aplikasi ini, silakan buat toko terlebih
                                dahulu.</p>
                    ...
                    <div class="card h-100 shadow-sm border-0">
                        ...
                        <div class="card-body text-center">
                            ...
                            @elseif ($store->status == 'verified')
                                <h1>Total Poin</h1>
                                <h2>{{ number_format($store->total_points) }}</h2>
                                <div class="mt-3">
                                    <a href="{{ route('toko.points.index') }}" class="btn btn-sm btn-outline-primary">Lihat Riwayat</a>
                                </div>
                            @else
                                <div class="mb-3">
                                    ...
                                    <div id="storePhotosCarousel" class="carousel slide" data-bs-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img src="{{ asset('storage/' . $store->foto1) }}"
                                                    class="d-block w-100 rounded" alt="Foto Toko 1"
                                                    style="height: 200px; object-fit: cover;">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="{{ asset('storage/' . $store->foto2) }}"
                                                    class="d-block w-100 rounded" alt="Foto Toko 2"
                                                    style="height: 200px; object-fit: cover;">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="{{ asset('storage/' . $store->foto3) }}"
                                                    class="d-block w-100 rounded" alt="Foto Toko 3"
                                                    style="height: 200px; object-fit: cover;">
                                            </div>
                                        </div>
                                        <button class="carousel-control-prev" type="button"
                                            data-bs-target="#storePhotosCarousel" data-bs-slide="prev">
                                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Previous</span>
                                        </button>
                                        <button class="carousel-control-next" type="button"
                                            data-bs-target="#storePhotosCarousel" data-bs-slide="next">
