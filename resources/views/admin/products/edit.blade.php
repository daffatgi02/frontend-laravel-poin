                            ...
                            <select class="form-select @error('store_id') is-invalid @enderror" id="store_id"
                                ...
                                @foreach ($stores as $store)
                                    <option value="{{ $store->id_toko }}"
                                        {{ old('store_id', $product->store_id) == $store->id_toko ? 'selected' : '' }}>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control @error('stok') is-invalid @enderror" id="stok"
                                name="stok" value="{{ old('stok', $product->stok) }}" required min="0">
                            @error('stok')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control @error('reward_poin') is-invalid @enderror"
                                id="reward_poin" name="reward_poin" value="{{ old('reward_poin', $product->reward_poin) }}"
                                required min="0">
                            @error('reward_poin')
                                <div class="invalid-feedback">
                                    {{ $message }}
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        @enderror
                                        <div class="form-text">Upload gambar baru untuk mengganti foto yang ada (opsional).
                                            Format: JPG, JPEG, atau PNG. Maksimal 2MB.</div>
                                    </div>
                                    <div class="col-md-4 text-center">
                                        <img id="preview"
                                            src="{{ $product->foto_produk ? asset('storage/' . $product->foto_produk) : 'https://placehold.co/150?text=No+Image' }}"
