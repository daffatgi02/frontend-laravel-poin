            ...
            <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('reward_poin') is-invalid @enderror" id="reward_poin" name="reward_poin" value="{{ old('reward_poin') }}" required min="0">
                        @error('reward_poin')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="mb-3">
                    <label for="foto_produk" class="form-label">Foto Produk <span class="text-danger">*</span></label>
                    <div class="card mb-2">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8">
                                    <input type="file" class="form-control @error('foto_produk') is-invalid @enderror" id="foto_produk" name="foto_produk" accept="image/jpeg,image/png,image/jpg" required onchange="previewImage(this)">
                                    @error('foto_produk')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    @enderror
                                    <div class="form-text">Upload gambar dengan format JPG, JPEG, atau PNG. Maksimal 2MB.</div>
                                </div>
