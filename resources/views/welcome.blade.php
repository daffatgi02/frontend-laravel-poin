        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6" data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <p class="lead mb-4">Bergabunglah dengan platform distributor kami dan dapatkan berbagai keuntungan ekslusif. Jual produk kami dan klaim poin reward untuk setiap transaksi!</p>
                ...
                <div class="col-lg-6 d-none d-lg-block" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
                    <img src="https://images.unsplash.com/photo-1556742031-c6961e8560b0?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Hero Image" class="img-fluid rounded-3 shadow-lg">
                </div>
            </div>
        </div>
        <div class="wave">
        ...
        <div class="container py-5">
            <div class="row justify-content-center text-center mb-5">
                <div class="col-lg-8" data-aos="fade-up">
                    ...
                    <p class="lead">Platform kami dirancang untuk memudahkan pengelolaan toko dan meningkatkan penjualan Anda dengan berbagai fitur canggih.</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 mb-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="feature-card p-4">
                        ...
                        <p class="text-muted">Kelola toko Anda dengan mudah menggunakan dashboard yang intuitif. Lacak penjualan, stok, dan kinerja secara real-time.</p>
                    </div>
                </div>
                <div class="col-md-4 mb-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="feature-card p-4">
                        ...
                        <p class="text-muted">Akses katalog produk lengkap dengan informasi detail, stok, harga, dan poin reward untuk setiap produk.</p>
                    </div>
                </div>
                <div class="col-md-4 mb-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="feature-card p-4">
                        ...
                        <p class="text-muted">Dapatkan poin untuk setiap penjualan dan tukarkan dengan berbagai hadiah menarik atau potongan harga untuk pembelian berikutnya.</p>
                    </div>
                </div>
                <div class="col-md-4 mb-4" data-aos="fade-up" data-aos-delay="400">
                    <div class="feature-card p-4">
                        ...
                        <p class="text-muted">Dapatkan insight bisnis dengan laporan penjualan detail, tren produk, dan analisis penjualan untuk keputusan bisnis yang lebih baik.</p>
                    </div>
                </div>
                <div class="col-md-4 mb-4" data-aos="fade-up" data-aos-delay="500">
                    <div class="feature-card p-4">
                        ...
                        <p class="text-muted">Dapatkan materi pemasaran dan promosi untuk membantu meningkatkan penjualan dan menarik lebih banyak pelanggan.</p>
                    </div>
                </div>
                <div class="col-md-4 mb-4" data-aos="fade-up" data-aos-delay="600">
                    <div class="feature-card p-4">
                        ...
                        <p class="text-muted">Tim dukungan kami siap membantu Anda kapan saja. Dapatkan solusi cepat untuk setiap masalah yang Anda hadapi.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container py-5">
            <div class="row justify-content-center mb-5">
                <div class="col-lg-8 text-center" data-aos="fade-up">
                    ...
                    <p class="lead">Bergabunglah dengan kami dan rasakan berbagai manfaat yang akan membantu mengembangkan bisnis Anda.</p>
                </div>
            </div>
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <img src="https://images.unsplash.com/photo-1556741533-6e6a62bd8b49?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Benefits" class="img-fluid rounded-3 shadow-lg" data-aos="fade-right">
                </div>
                <div class="col-lg-6">
                    <div class="d-flex mb-4" data-aos="fade-left" data-aos-delay="100">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0">Dapatkan margin keuntungan yang kompetitif untuk setiap produk yang Anda jual.</p>
                        </div>
                    </div>
                    <div class="d-flex mb-4" data-aos="fade-left" data-aos-delay="200">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0">Kumpulkan poin untuk setiap transaksi dan tukarkan dengan hadiah atau potongan harga.</p>
                        </div>
                    </div>
                    <div class="d-flex mb-4" data-aos="fade-left" data-aos-delay="300">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0">Nikmati layanan pengiriman cepat langsung ke toko Anda untuk memastikan stok selalu tersedia.</p>
                        </div>
                    </div>
                    <div class="d-flex mb-4" data-aos="fade-left" data-aos-delay="400">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0">Dapatkan pelatihan dan pendampingan untuk meningkatkan kemampuan bisnis Anda.</p>
                        </div>
                    </div>
                    <div class="d-flex" data-aos="fade-left" data-aos-delay="500">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0">Dapatkan materi promosi dan strategi pemasaran untuk meningkatkan penjualan produk.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container py-5">
            <div class="row justify-content-center text-center mb-5">
                <div class="col-lg-8" data-aos="fade-up">
                    ...
                    <p class="lead">Bergabung dan mendapatkan keuntungan dari program kami sangat mudah. Ikuti langkah-langkah di bawah ini untuk memulai.</p>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="400">
                    <div class="step-card">
                        ...
                        <p class="text-muted">Tukarkan poin yang telah Anda kumpulkan dengan berbagai hadiah menarik.</p>
        ...
        <div class="container py-5">
            <div class="row justify-content-center text-center mb-5">
                <div class="col-lg-8" data-aos="fade-up">
                    ...
                    <p class="lead">Dengarkan langsung dari para pemilik toko yang telah bergabung dan merasakan manfaatnya.</p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="testimonial-card">
                        ...
                        <p class="mb-0">Bergabung dengan platform ini adalah keputusan bisnis terbaik yang pernah saya buat. Penjualan meningkat 30% dan sistem poin reward sangat menguntungkan!</p>
                        <div class="mt-3">
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="testimonial-card">
                        ...
                        <p class="mb-0">Program poin reward sangat menarik dan menguntungkan! Saya sudah menukarkan poin dengan berbagai hadiah dan potongan harga untuk pesanan berikutnya.</p>
                        <div class="mt-3">
                            <i class="fas fa-star text-warning"></i>
                            <i class="fas fa-star text-warning"></i>
                            <i class="fas fa-star text-warning"></i>
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="testimonial-card">
                        ...
                        <p class="mb-0">Dukungan tim sangat luar biasa! Mereka membantu saya dari awal pendaftaran hingga strategi pemasaran. Toko saya kini menjadi lebih ramai dan profit meningkat.</p>
                        <div class="mt-3">
                            <i class="fas fa-star text-warning"></i>
                            <i class="fas fa-star text-warning"></i>
                            <i class="fas fa-star text-warning"></i>
        ...
        <div class="container py-5">
            <div class="row justify-content-center text-center mb-5">
                <div class="col-lg-8" data-aos="fade-up">
                    ...
                    <p class="lead">Kami bermitra dengan brand terkemuka untuk menyediakan produk berkualitas untuk toko Anda.</p>
                </div>
            </div>
            <div class="row align-items-center">
                <div class="col-md-2 col-6 mb-4 mb-md-0" data-aos="fade-up" data-aos-delay="100">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/24/Samsung_Logo.svg/1280px-Samsung_Logo.svg.png" alt="Partner" class="img-fluid partner-logo mx-auto d-block">
                </div>
                <div class="col-md-2 col-6 mb-4 mb-md-0" data-aos="fade-up" data-aos-delay="200">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/HP_logo_2012.svg/1200px-HP_logo_2012.svg.png" alt="Partner" class="img-fluid partner-logo mx-auto d-block">
                </div>
                <div class="col-md-2 col-6 mb-4 mb-md-0" data-aos="fade-up" data-aos-delay="300">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Google_2015_logo.svg/1200px-Google_2015_logo.svg.png" alt="Partner" class="img-fluid partner-logo mx-auto d-block">
                </div>
                <div class="col-md-2 col-6 mb-4 mb-md-0" data-aos="fade-up" data-aos-delay="400">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/Apple_logo_black.svg/1024px-Apple_logo_black.svg.png" alt="Partner" class="img-fluid partner-logo mx-auto d-block" style="height: 60px;">
                </div>
                <div class="col-md-2 col-6 mb-4 mb-md-0" data-aos="fade-up" data-aos-delay="500">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/Microsoft_logo.svg/1024px-Microsoft_logo.svg.png" alt="Partner" class="img-fluid partner-logo mx-auto d-block">
                </div>
                <div class="col-md-2 col-6 mb-4 mb-md-0" data-aos="fade-up" data-aos-delay="600">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Amazon_logo.svg/1024px-Amazon_logo.svg.png" alt="Partner" class="img-fluid partner-logo mx-auto d-block">
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-8 faq-section">
                    <div class="accordion" id="accordionFAQ">
                        <div class="card" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionFAQ">
                                <div class="card-body">
                                    Untuk bergabung dengan program kami, Anda perlu mendaftar di website ini dengan mengisi informasi toko Anda. Setelah verifikasi, Anda akan memiliki akses ke seluruh fitur platform kami.
                                </div>
                            </div>
                        </div>
                        <div class="card" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionFAQ">
                                <div class="card-body">
                                    Setiap produk yang Anda jual memiliki nilai poin tertentu. Setiap kali Anda melakukan penjualan, poin akan otomatis ditambahkan ke akun Anda. Poin tersebut dapat ditukarkan dengan berbagai hadiah atau potongan harga untuk pembelian berikutnya.
                                </div>
                            </div>
                        </div>
                        <div class="card" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-bs-parent="#accordionFAQ">
                                <div class="card-body">
                                    Tidak, pendaftaran untuk menjadi mitra kami sepenuhnya gratis. Anda hanya perlu memenuhi persyaratan verifikasi toko untuk bergabung.
                                </div>
                            </div>
                        </div>
                        <div class="card" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-bs-parent="#accordionFAQ">
                                <div class="card-body">
                                    Proses verifikasi toko biasanya membutuhkan waktu 1-3 hari kerja. Tim kami akan melakukan verifikasi untuk memastikan informasi yang Anda berikan valid.
                                </div>
                            </div>
                        </div>
                        <div class="card" data-aos="fade-up" data-aos-delay="500">
                            ...
                            <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-bs-parent="#accordionFAQ">
                                <div class="card-body">
                                    Untuk menukarkan poin, Anda dapat mengunjungi halaman "Tukar Poin" di dashboard Anda. Pilih hadiah yang Anda inginkan dan klik tombol "Tukar". Poin akan otomatis dipotong dari saldo Anda.
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-4 mb-lg-0">
                    ...
                    <p class="mb-4">Platform distributor terkemuka yang menghubungkan perusahaan dengan toko-toko di seluruh Indonesia. Nikmati rewards dan keuntungan setiap kali Anda menjual produk kami.</p>
                ...
                <div class="col-lg-2 col-md-4 mb-4 mb-md-0">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#">Makanan & Minuman</a></li>
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item mb-3">
                            <div class="d-flex">
                                ...
                                <p class="mb-0">Jl. Raya Distributor No. 123, Jakarta Pusat, Indonesia</p>
                            </div>
                        </li>
                        <li class="nav-item mb-3">
                            <div class="d-flex">
                        ...
                        <li class="nav-item mb-3">
                            <div class="d-flex">
                                ...
                                <p class="mb-0">info@perusahaan.com</p>
                            </div>
                        </li>
                    </ul>
                </div>
