                ...
                @if ($products->count() > 0)
                    ...
                    <div class="row">
                        @foreach ($products as $product)
                            <div class="col-md-4 mb-4 product-card">
                                <div class="card h-100 shadow-sm hover-shadow">
                                    <div class="position-relative">
                                        ...
                                        @else
                                            <img src="https://placehold.co/300x200?text=No+Image" class="card-img-top"
                                                alt="No Image" style="height: 200px; object-fit: cover;">
                                        @endif
                                        <div class="position-absolute top-0 end-0 p-2">
                                            <span class="badge bg-primary">{{ number_format($product->reward_poin) }}
                                                Poin</span>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                    ...
                                    <div class="card-footer bg-white">
                                        <button type="button" class="btn btn-sm btn-outline-primary w-100"
                                            ...
                                            data-bs-target="#productModal-{{ $product->id_produk }}">
                            ...
                            <!-- Modal Detail Produk -->
                            <div class="modal fade" id="productModal-{{ $product->id_produk }}" tabindex="-1"
                                aria-labelledby="productModalLabel-{{ $product->id_produk }}" aria-hidden="true">
